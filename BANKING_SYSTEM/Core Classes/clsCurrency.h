...
const string File_Name = "Data/Currencies.txt";
...
private:
    ...
    static clsCurrency _ConvertLinetoCurrencyObject(string Line, string Seperator = " || ")
    {
        ...
        vCurrencyData = clsString::Split_String(Line, Seperator);
    ...
    static void _SaveCurrencyDataToFile(vector <clsCurrency> vCurrencys)
    {
        ...
        fstream MyFile;
        MyFile.open(File_Name, ios::out);//overwrite
...
public:
    ...
    static   clsCurrency FindByCode(string CurrencyCode)
    {
        ...
        CurrencyCode = clsString::Upper_str(CurrencyCode);
    ...
    {
        Country = clsString::Upper_str(Country);
        ...
        if (MyFile.is_open())
        {
            ...
            {
                clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
                if (clsString::Upper_str(Currency.Country()) == Country)
                {
                    MyFile.close();
                    return Currency;
                }
